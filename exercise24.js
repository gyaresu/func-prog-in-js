...
function() {
    ...
    return movieLists.concatMap(function(movieList) {
        return movieList.videos.concatMap(function(videos) {
            return Array.zip(
                videos.boxarts.reduce(function(first, next) {
                    return first.width * first.height < next.width * next.height ? first: next;
                }),
                    videos.interestingMoments.filter(function(moment) {
                        return moment.type === "Middle";
                }),
                    function(boxart, interestingMoment){
                        return {id: videos.id, title: videos.title, time: interestingMoment.time, url: boxart.url};
                }
            );
        });
    });
